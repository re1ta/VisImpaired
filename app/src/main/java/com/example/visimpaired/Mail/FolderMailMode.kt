...
class FolderMailMode(private val context: Context, name: String?, private val folder: Folder, private val mailFolderList : MailFolderList): Item(context, name), LifecycleItem {
    private var page = 0
